package com.ourfitness.fitnessabs.les_utils;
...
public class jibreq_Wa_rawabs_l_eeqrest extends Drawable {
    protected int alpha;
    ...
    public jibreq_Wa_rawabs_l_eeqrest(int i, int i2, long j) {
        this(i, i2);
    ...
    public jibreq_Wa_rawabs_l_eeqrest(int i, int i2) {
        this.number = 0;
        this.inerRadius = 0;
