...
import com.ourfitness.fitnessabs.the_interage_alstorag.all_var_contan;
import com.ourfitness.fitnessabs.the_interage_alstorag.les_preferens;
...
public class Perform_excrise_activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public les_preferens lespreferens;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_exser_perform);
        this.lespreferens = new les_preferens(this);
        ...
        this.likeunlikebtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (Perform_excrise_activity.this.islike) {
                    ...
                    performexcriseactivity.setfav(performexcriseactivity.islike, ((fitness_helpers) Perform_excrise_activity.this.yougahelpers.get(Perform_excrise_activity.this.currenposition)).getId());
                    ...
                    performexcriseactivity2.setfav(performexcriseactivity2.islike, ((fitness_helpers) Perform_excrise_activity.this.yougahelpers.get(Perform_excrise_activity.this.currenposition)).getId());
                    Perform_excrise_activity.this.checkfav();
                }
            }
        });
    ...
    public void checkfav() {
        if (this.favouritedatabse.isfav(this.yougahelpers.get(this.currenposition).getId())) {
            this.islike = true;
            this.lileicon.setImageResource(R.drawable.ic_baseline_settings_24);
            return;
        }
        this.islike = false;
        this.lileicon.setImageResource(R.drawable.ic_baseline_settings_24);
    ...
    public void setfav(boolean z, String str) {
        this.favouritedatabse.updatedata(str, z ? getString(R.string.numberone) : getString(R.string.numberzero));
    }
    ...
    public void timer(int i) {
        ...
        this.countDownTimer = new CountDownTimer((long) (i * 1000), 1000) {
            ...
            public void onFinish() {
                ...
                if (performexcriseactivity.lespreferens.getString(all_var_contan.EXCERISE_OPTION).equals(all_var_contan.AUTOMATICALLY)) {
                    Perform_excrise_activity performexcriseactivity2 = Perform_excrise_activity.this;
                    performexcriseactivity2.runresttimer(performexcriseactivity2.lespreferens.getInt(all_var_contan.WORKOUT_REST));
                    return;
                }
                Perform_excrise_activity.this.progressBar.setProgress(i2);
                Perform_excrise_activity.this.countertext.setText( getString(R.string.numberone));
                Perform_excrise_activity.this.startbtntext.setText(Perform_excrise_activity.START);
            }
        }.start();
    }
