...
import com.ourfitness.fitnessabs.bamya.CalculateBMI;
import com.ourfitness.fitnessabs.bamya.bmidatatable;

import java.text.SimpleDateFormat;
import java.util.Date;

public class theBMya_calculsator_e extends Fragment implements View.OnClickListener {
    ...
    TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            theBMya_calculsator_e.this.resultsect.setVisibility(View.GONE);
        }
    };
